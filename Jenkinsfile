node
{
	...
	{
slackSend baseUrl: 'https://hooks.slack.com/services/', channel: '#jenkins-pipeline-11-21-2020', color: 'good', message: 'TestTestTestTestTest - Bharat', tokenCredentialId: 'slack1121-2', username: 'test slack'	}
